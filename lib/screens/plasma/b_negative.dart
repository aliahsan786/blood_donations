...
class BNegative extends StatelessWidget {
  const BNegative({Key? key}) : super(key: key);
              ...
              if (snapshot.data!.docs.length > 0) {
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    bool isEmergency = snapshot.data!.docs[index]
                            ['requestType'] ==
                        "Emergency Request";
      ...
      child: Column(
        children: [
          ...
          Tiles(
            ...
            title: "Looking For Blood  ${requestModel?.bloodGroup}",
          ),
          Tiles(
                    ...
                    onPressed: () {
                      if (requestModel?.userId !=
                        ...
                        chatController.createChatRoomandStartCOnversition(
                            requestModel?.userId!, requestModel?.name!);
                      } else {
                        showCustomSnackBar(
                  ...
                  child: MySmallButton(
                    ...
                    onPressed: () async {
                      if (requestModel?.phone != "" &&
                        ...
                        String url = 'tel:${requestModel?.phone}';
